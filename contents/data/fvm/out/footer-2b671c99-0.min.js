...
e.handled=!0}else{return!1}});if(typeof jQuery.goMap!=='undefined'&&$.GoPricing.$wrap.find('.gw-go-gmap').length){var GoPricing_MapResize=!1;$(window).on('resize',function(e){if(GoPricing_MapResize){clearTimeout(GoPricing_MapResize)}
...
$.fn.tablespy=function(options){var defaults={offset:0,enters:0,leaves:0,inside:!1};return this.each(function(){var $elem=$(this);var top=$elem.offset().top;$elem.data("tablespy",$.extend({min:top,max:top+$elem.outerHeight(),rowHeight:$elem.children(":visible:first").outerHeight()},defaults,options));$elems.push(this)})}})(jQuery,window)
