...
* fixed : function wp_head() moved just before the closing <head>
<base href="/" />
 tag
...
= 2.0.4 May 16th, 2013 =
* fixed : test on current_user_can( 'edit_post' ) in template part content-page.php was generating a Notice: Undefined offset: 0 in ~/inc/capabilities.php on line 1067
